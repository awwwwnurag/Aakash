...
navigator.geolocation.getCurrentPosition(async function (position) {
    ...
    try {
        ...
        weatherMain[1].innerHTML = weatherDescription;
        ...
        // Update new weather detail elements
        windElement.innerHTML = data.list[0].wind.speed + " m/s";
        ...
        let sunriseTime = new Date(data.city.sunrise * 1000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
        let sunsetTime = new Date(data.city.sunset * 1000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
